...
@Component
public class CorporateCurrentacc implements JavaDelegate{
    ...
    private final static Logger LOGGER = Logger.getLogger(CorporateCurrentacc.class.getName());
    ...
    public void execute(DelegateExecution execution) throws Exception {
         ...
         if(response instanceof ApiError ||  response instanceof GenericError){
            //Failure Path
            throw new RuntimeException("Error occurred in the adapter:"+CorporateCurrentacc.class.getName());
         }else{
