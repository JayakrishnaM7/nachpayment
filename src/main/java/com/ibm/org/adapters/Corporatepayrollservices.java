...
@Component
public class Corporatepayrollservices implements JavaDelegate{

    @Autowired
    private Utility utility;

    @Autowired
    private CorporatepayrollservicesRestProcessor restProcessor;

    private final static Logger LOGGER = Logger.getLogger(Corporatepayrollservices.class.getName());
    ...
    public void execute(DelegateExecution execution) throws Exception {
         ...
         if(response instanceof ApiError ||  response instanceof GenericError){
            //Failure Path
            throw new RuntimeException("Error occurred in the adapter:"+Corporatepayrollservices.class.getName());
         }else{
