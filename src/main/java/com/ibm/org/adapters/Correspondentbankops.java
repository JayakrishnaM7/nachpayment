...
@Component
public class Correspondentbankops implements JavaDelegate{
    ...
    private final static Logger LOGGER = Logger.getLogger(Correspondentbankops.class.getName());
    ...
    public void execute(DelegateExecution execution) throws Exception {
         ...
         if(response instanceof ApiError ||  response instanceof GenericError){
            //Failure Path
            throw new RuntimeException("Error occurred in the adapter:"+Correspondentbankops.class.getName());
         }else{
