...
@Component
public class Internalbankacc implements JavaDelegate{

    @Autowired
    private Utility utility;

    @Autowired
    private InternalbankaccRestProcessor restProcessor;

    private final static Logger LOGGER = Logger.getLogger(Internalbankacc.class.getName());
    ...
    public void execute(DelegateExecution execution) throws Exception {
         ...
         if(response instanceof ApiError ||  response instanceof GenericError){
            //Failure Path
            throw new RuntimeException("Error occurred in the adapter:"+Internalbankacc.class.getName());
         }else{
